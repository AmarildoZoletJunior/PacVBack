...
namespace Booking.Application.Validators
{
    public class PaymentValidator : AbstractValidator<Payment>
    {
        public PaymentValidator()
        {
            ...
            RuleFor(x => x.Value).NotNull().WithMessage("O campo Valor não pode ser nulo.").NotEmpty().WithMessage("O campo Valor não pode ser vazio.").LessThan(20).WithMessage("O campo Valor não pode ser menor que 20.");
